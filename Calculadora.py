...
from tkinter import *# Se pone asteristo para poner los metodos que estasmo usando

ventana = Tk()
ventana.geometry("365x345+400+20")
...
class HoverButton(Button):
    def _init_(self,master, **kw):
        ...
        self.defaultBackground = self["bacground"]
        self.bind("<Enter>", self.on_enter)
        self.bind("<Leave>", self._leave)

# Cambiar el color del teclado al pasar el mouse
    def on_enter(self, e):
...
Resultado = Entry(frame, bg='#9EF8E8', width=18, relief='groove',font= 'Monserrat 16', justify = 'right')
...
Button7 = HoverButton(frame, text= "7", height=2, width=5, font= ('Comic sens MC', 12, 'bold'),
                      borderwidth=2, relief = "raised", activebackground="aqua", bg= '#999AB8', 
...
Button_borrarU = HoverButton(frame, text= "DEL", height=2, width=5, font= ('Comic sens MC', 12, 'bold'),
                      borderwidth=2, relief = "raised", activebackground="red", bg= '#FD0371',
                      anchor= "center", command=lambda: borrar_uno())
Button_borrarU.grid(column= 3, row= 1, pady=2, padx= 2)
...
Button_mas = HoverButton(frame, text= "+", height=2, width=5, font= ('Comic sens MC', 12, 'bold'),
                       borderwidth=2, relief = "raised", activebackground="#FEEF02", bg= '#2A16F7', 
                      anchor= "center", command=lambda: obtener('+'))
Button_mas.grid(column= 3, row= 2, pady=2, padx= 2)

# Fila 3

Button1 = HoverButton(frame, text= "1", borderwidth=2, height=2, width=5, font= ('Comic sens MC', 
                        12, 'bold'), relief = "raised", activebackground="aqua", bg= '#999AB8',
                        anchor= "center", command=lambda: obtener(1))
Button1.grid(column= 0, row= 3, pady=1, padx= 3)
...
Button_igual = HoverButton(frame, text= "=", height=2, width=13, font= ('Comic sens MC', 12, 'bold'),
                        borderwidth=2, relief = "raised", activebackground="#16FD03", bg= '#2FEC71',
                        anchor= "center", command=lambda: operacion())
Button_igual.grid(column= 1, columnspan=2, row= 5, pady=1, padx= 1)
Button_borrarT = HoverButton(frame, text= "C", height=2, width=5, font= ('Comic sens MC', 12, 'bold'),
                      borderwidth=2, relief = "raised", activebackground="red", bg= '#FD5603', 
                      anchor= "center", command=lambda: borrar_todo())
Button_borrarT.grid(column= 3, row= 5, pady=2, padx= 2)
